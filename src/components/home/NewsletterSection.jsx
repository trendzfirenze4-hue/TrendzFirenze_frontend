...
//       <div className="relative mx-auto w-full max-w-[920px] px-4 py-14 text-center sm:px-6 sm:py-16 lg:max-w-full lg:px-10 lg:py-20">
    ...
    <section className="relative w-full overflow-hidden bg-white">
      ...
      <div className="relative w-full px-4 py-14 sm:px-6 sm:py-16 lg:px-10 lg:py-20">
        ...
        <div className="mx-auto w-full max-w-[920px] text-center">
          ...
          <form className="mx-auto mt-8 flex w-full max-w-[620px] animate-[fadeUp_0.9s_ease-out] flex-col gap-3 sm:flex-row sm:items-center">
            <div className="group relative flex-1">
              <input
                type="email"
                placeholder="Enter your email"
