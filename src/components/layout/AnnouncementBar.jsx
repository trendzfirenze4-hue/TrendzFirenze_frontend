      ...
      <div className="mx-auto max-w-screen-2xl px-3 sm:px-4 lg:px-6">
        <div className="relative flex min-h-[40px] items-center justify-center sm:min-h-[42px]">
          <button
            ...
            onClick={handlePrev}
            aria-label="Previous announcement"
            className="group absolute left-[15%] sm:left-[25%] top-1/2 z-10 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full transition-all duration-300 hover:bg-white/10 active:scale-95"
          >
            <svg
              className="h-3.5 w-3.5 text-white transition-all duration-300 group-hover:-translate-x-0.5"
              viewBox="0 0 24 24"
          ...
          <button
            ...
            onClick={handleNext}
            aria-label="Next announcement"
            className="group absolute right-[15%] sm:right-[25%] top-1/2 z-10 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full transition-all duration-300 hover:bg-white/10 active:scale-95"
          >
            <svg
              className="h-3.5 w-3.5 text-white transition-all duration-300 group-hover:translate-x-0.5"
              viewBox="0 0 24 24"
